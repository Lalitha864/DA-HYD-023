...
#we use [start:end] #start default --> 0,start is included,end is exclucded
...
#slicing is applicable from lower index to hiher index
...
print(name[1:-2])
print(name[2:-6])
#observe +ve,+ve,-ve-ve & +ve,-ve all possiblities
...
for i in 'codegnan':
    print(i)
#in above case we get every charcter line by line

for i in 'codegnan':
    print(i,end=' ')

name = "Codegnan"
#bulit-in functions --> len(),min(),max(),sorted()
print(len(name))
...
#Methods on strings --> Case-Conversion,Findings/Searching...
name = 'Codegnan data'
#Case-convention -->upper(),lower(),title(),capitalize()
a = name.upper()
print(a)
b = name.lower()
print(b)
#Capitalizer() --> converts first letter to uppercase
c = name.capitalize()
print(c)
