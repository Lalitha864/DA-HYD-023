...
a = a.replace('g','s')
print(a)
print('fghyujiki#jkasjkakaj#nmasajkm'.replace('#',''))
...
print('8247261951',isdigit())
print('2345',isunumeric()) #this has upper edge (numbers,fractions,romans)
